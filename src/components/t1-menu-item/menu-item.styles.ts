...
export default css`
  ...
  .menu-item {
    ...
    padding: var(--t1-spacing-2x-small) var(--t1-spacing-2x-small);
  ...
  .menu-item.menu-item--loading *:not(t1-spinner) {
    opacity: 0.5;
  }

  .menu-item--loading t1-spinner {
  ...
  .menu-item--has-prefix .menu-item__prefix {
  ...
  .menu-item--has-suffix .menu-item__suffix {
  ...
  .menu-item--submenu-expanded::after {
    content: '';
    position: fixed;
    z-index: calc(var(--t1-z-index-dropdown) - 1);
    top: 0;
    right: 0;
    bottom: 0;
    left: 0;
  ...
  .menu-item--rtl t1-popup::part(popup) {
