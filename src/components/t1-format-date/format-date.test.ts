...
describe('t1-format-date', () => {
  ...
  describe('invalid date', () => {
    it('renders nothing for an invalid date', async () => {
      const el = createElement();
      el.date = 'not-a-date';
      await el.updateComplete;
      expect(text(el)).toBe('');
  ...
  describe('time-zone', () => {
    it('formats with a given timeZone', async () => {
      const el = createElement();
      el.date = JAN_1;
  ...
  describe('<time> element', () => {
    it('renders a <time> element with a datetime attribute', async () => {
      const el = createElement();
      el.date = JAN_1;
      el.year = 'numeric';
      await el.updateComplete;
