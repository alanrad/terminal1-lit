...
export default css`
  ...
  .alert--primary {
    border-top-color: var(--t1-color-primary-600);
  }
  ...
  .alert--success {
    border-top-color: var(--t1-color-success-600);
  }
  ...
  .alert--neutral {
    border-top-color: var(--t1-color-neutral-600);
  }
  ...
  .alert--warning {
    border-top-color: var(--t1-color-warning-600);
  }
  ...
  .alert--danger {
    border-top-color: var(--t1-color-danger-600);
  }
