...
export default css`
  ...
  .badge {
    ...
    border: solid 1px var(--t1-color-neutral-0);
    white-space: nowrap;
  ...
  .badge--pulse.badge--primary {
    --pulse-color: var(--t1-color-primary-600);
  }

  .badge--pulse.badge--success {
    --pulse-color: var(--t1-color-success-600);
  }

  .badge--pulse.badge--neutral {
    --pulse-color: var(--t1-color-neutral-600);
  }

  .badge--pulse.badge--warning {
    --pulse-color: var(--t1-color-warning-600);
  }

  .badge--pulse.badge--danger {
    --pulse-color: var(--t1-color-danger-600);
  }
