...
describe('t1-format-number', () => {
  ...
  describe('significant digits', () => {
    it('respects minimum-significant-digits', async () => {
    ...
    it('respects maximum-significant-digits', async () => {
  ...
  describe('invalid value', () => {
    it('renders empty string for NaN', async () => {
      const el = createElement();
      await el.updateComplete;
      el.value = NaN;
      await el.updateComplete;
  ...
  describe('minimum-integer-digits', () => {
    it('pads integer digits', async () => {
